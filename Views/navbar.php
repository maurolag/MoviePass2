...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <a class="navbar-brand " href="<?php echo FRONT_ROOT?>Home/View">
          <img src="<?php echo FRONT_ROOT.VIEWS_PATH?>img/profileej.png" width="30" height="30" class="d-inline-block align-top">
            MoviePass
        </a>
              ...
              echo  FRONT_ROOT.VIEWS_PATH.'img/profileej.png" width="30" height="30" class="d-inline-block align-top">
                    <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="#"><i class="fas fa-user-alt"></i>&nbspMi Perfil</a>
                        <a class="dropdown-item" href="#"><i class="fas fa-ticket-alt"></i>&nbspMis Tickets</a>
